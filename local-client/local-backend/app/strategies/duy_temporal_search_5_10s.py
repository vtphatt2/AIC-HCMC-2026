...
class DuyTemporalSearchInterval5to10s(BaseStrategy):
    """
    ...
    within [5000, 10000] ms.
    """

    name = "Temporal Search v2 (5-10s)"
    description = (
        "DP temporal localization across multiple query groups, restricted to "
        "chains whose first-to-last frame span is within 5-10s."
    )
    author = "Team AIC 2026"
    version = "1.0"

    INTERVAL_MIN_MS = 5_000
