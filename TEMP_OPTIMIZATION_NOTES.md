...
- Before the config fix, logs showed 1,643 frame requests / 1,488 HTTP 502s, including retries; 739 were S01-V010. Organizer ZIP range requests were HTTP 206, so corruption is not established. After the fix, L23_V021 and M06_V001 spot images returned HTTP 200 in 2.4 s and 2.7 s; S01-V010 returned cached HTTP 200. Too few checks to call S/M fully resolved. User reports L slower than old system, S very slow/missing, and some M missing. Linear full-video decode is unverified.
